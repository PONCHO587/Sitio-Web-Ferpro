...
// Modal para las cards de la sección Herramientas Más Compradas
document.querySelectorAll('.open-cart-modal_dos').forEach((button) => {
    button.addEventListener('click', (e) => {
      e.preventDefault(); // Evita recargar la página
      document.getElementById('cart-modal_dos').style.display = 'flex';
    });
  });
  
  document.getElementById('close-cart_dos').addEventListener('click', () => {
    document.getElementById('cart-modal_dos').style.display = 'none';
  });
  
  // Cerrar modal al hacer clic fuera de él
  window.addEventListener('click', (e) => {
    const modal = document.getElementById('cart-modal_dos');
    if (e.target === modal) {
